  ...
  if (wrongNetwork) {
    return (
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: "50vh", padding: "24px" }}>
        <div style={{ textAlign: "center", maxWidth: "380px", background: "var(--surface)", borderRadius: "16px", padding: "40px 32px", border: "1px solid var(--border)" }}>
          ...
          <button
            onClick={connect}
            style={{ background: "var(--beacon-green)", color: "#fff", borderRadius: "8px", padding: "10px 24px", fontWeight: 600, border: "none", cursor: "pointer", width: "100%" }}
          >
            Switch network
          </button>
        </div>
    ...
    return (
      <div style={{ display: "flex", alignItems: "center", justifyContent: "center", minHeight: "50vh", padding: "24px" }}>
        <div style={{ textAlign: "center", maxWidth: "380px", background: "var(--surface)", borderRadius: "16px", padding: "40px 32px", border: "1px solid var(--border)" }}>
          ...
          <h2 style={{ fontWeight: 700, fontSize: "1.1rem", marginBottom: "8px" }}>Sign in to continue</h2>
          <p style={{ color: "var(--muted)", fontSize: "0.9rem", lineHeight: 1.5, marginBottom: "24px" }}>
            Beacon is on-chain. Your reports are yours. Sign in with your email or wallet to submit and track incidents.
          </p>
          <button
            onClick={connect}
            style={{ background: "var(--beacon-green)", color: "#fff", borderRadius: "8px", padding: "10px 24px", fontWeight: 600, border: "none", cursor: "pointer", width: "100%" }}
